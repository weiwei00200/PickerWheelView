...
/**
 * Created by liuwen on 2017/6/15.
 */
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = com.sammie.timepickerview.R.layout.pickerview_time;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.pickerview_confirm) : Str_Submit);
